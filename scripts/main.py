...
if __name__ in "__main__":
    ...
    scripts_and_args = [
        ...
        ("../scripts/module_fqtobam.py", ["--database", args.output, "--index", args.index, "--mode", args.mode, "--thread", str(args.thread)]),
        ("../scripts/module_binbysam.py", ["--sampath", args.sampath, "--controlfile", args.controlfile, "--binsize", str(args.binsize), "--breaks", args.breaks, "--ploidy", str(args.ploidy)])
    ]
